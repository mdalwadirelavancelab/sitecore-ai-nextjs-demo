...
const nextConfig: NextConfig = {
  ...
  // Custom setting: wait for metadata so its tags appear in <head> for everyone.
  // Without this, Next.js may send metadata later and add its tags to <body>.
  // This can make the page take longer to start loading.
  htmlLimitedBots: /.*/,
};
